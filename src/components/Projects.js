...
import { SiTailwindcss, SiJavascript, SiFirebase, SiTypescript, SiTensorflow, SiOpencv, SiKeras, SiNumpy } from 'react-icons/si';
...
const description3 = ' - This is my first personal project in Python and the first that involved machine learning\n\n - I chose this concept as it suited my interest in chess and covered concepts which I was familair with\n\n'+
' - The app takes in an image of a chess position and translates it in FEN(Forsyth-Edwards Notation)\n\n';
const description4 = ' - This is a group project that a few friends and I are working on\n\n - This is an app that allows users to create movie playlists and share those with other users\n\n'+
...
const Carousel = () => {
    return (
        <div className="carousel w-full h-[70vh] bg-slate-200 rounded-3xl">
            ...
            <div className='flex justify-around items-center w-full h-full bg-slate-100 rounded-3xl'>
                    <div className='flex flex-col justify-between w-[35%] h-[90%] items-center mt-[5%]'>
                        <img className='h-[60%] w-auto' src='https://cdn-icons-png.flaticon.com/512/4363/4363846.png' alt='No Image'/>
                        <div className='h-1/10 text-[3vw] flex items-center justify-evenly w-full'>
                            <DiPython/>
                            <SiTensorflow/>
                            <SiOpencv/>
                        ...
                        <div className='mb-[5%] font-bold'>
                            <h1 className='text-[2vw]'>Chess Board Recognition</h1>
                        </div>
                    </div>
                    <div className='flex flex-col w-[45%] h-[80%] items-center mt-[5%]'>
            ...
            <div className='flex justify-around items-center w-full h-full bg-slate-100 rounded-3xl'>
                    ...
                    <div className='flex flex-col w-[45%] h-[80%] items-center mt-[5%]'>
                        <p className='whitespace-pre-line text-left text-[1.5vw]'>{description4}</p>
                    </div>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide3" className="btn btn-circle">❮</a>
